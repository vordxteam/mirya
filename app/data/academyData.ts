const academyData = {
  ...
  "mirya-tutorials": {
    ...
    sidebar: [
      {
        ...
        subItems: [
          { id: "actions", title: "Mouse & Keyboard Actions" },
          { id: "filling", title: "Form Filling" },
          { id: "detection", title: "UI Elements Detection" },
          { id: "local-apps", title: "Working with local apps" },

        ],
      },
      {
        id: "automation", title: "Web Automation",
        subItems: [
          { id: "actions", title: "Mouse & Keyboard Actions" },
          { id: "filling", title: "Form Filling" },
          { id: "detection", title: "UI Elements Detection" },
      ...
      {
        id: "decisions",
        title: "Logic, Variables & Decisions",
        subItems: [
          { id: "actions", title: "Mouse & Keyboard Actions" },
          { id: "filling", title: "Form Filling" },
          { id: "detection", title: "UI Elements Detection" },
    ...
    rightCard: {
      title: "On this Page",
      items: [{ text: "Mouse & Keyboard Actions" }],
    },
  },
  "process-use-cases": {
    ...
    sidebar: [
      {
        ...
        title: "Finance & Accounting",
        subItems: [
          { id: "invoice", title: "Invoice Import" },
          { id: "payment", title: "Payment Runs" },
          { id: "Statements", title: "Bank Statements" },
...

      {
        ...
        subItems: [
          { id: "comparison", title: "Supplier offer comparison" },
          { id: "extraction", title: "Order Information Extraction" },
          { id: "status", title: "Delivery Status" },
      ...
      },
      {
        ...
        subItems: [
          { id: "invoice", title: "Policy Data" },
          { id: "information", title: "Contract Information" },
          { id: "Statements", title: "Bank Statements" },
          { id: "claims", title: "Preprocessing Claims" },
