  ...
  return (
    ...
    `,
          ...
          >
            <Link
              href="#"
              className="text-[12px] leading-4 flex items-center gap-2 font-normal text-white  rounded-full relative group"
            >
              <div
                className="absolute inset-0 rounded-full"
                style={{
                  background:
                    "linear-gradient(135deg, #38385D, #22223C, #22223C, #38385D  ,#686DDD)",
                }}
              />

              <div className="relative bg-[#00031C] rounded-full px-3 py-2 flex items-center gap-2">
                <svg
