...
//         <div className="absolute z-0 bottom-0 right-19 opacity-80 pointer-events-none">
//           <Image
//             src="/images/boxbg.png"
//             width={635}
//             height={340}
//             alt="background-box"
//             className="w-[280px] sm:w-[400px] lg:w-[530px] "
//           />
//         </div>
//       </div>
//     </div>
...
const Aiassistant = () => {
  return (
    /* 1. Added relative and overflow-hidden to the main section container */
    <div className="bg-[#00031C] relative overflow-hidden isolate">
      ...
      >
        ...
        <div className="max-w-[726px] w-full relative z-20">
          <div className="max-w-[510px] mx-auto lg:mx-0 text-center lg:text-left">
            {/* Section Tag */}
            <div className="pb-3 flex items-center justify-center lg:justify-start gap-3 sm:gap-5">
              <Image
        ...
        <div className="w-full lg:max-w-[464px] flex justify-center lg:justify-end relative z-20">
          <Image
            ...
            alt="assistant"
            priority
            className="w-full sm:w-[360px] lg:w-[464px] h-auto relative z-10"
          />
        </div>
        ...
        {/* BACKGROUND BOX IMAGE - Fixed with -z-10 and pointer-events-none */}
        <div className="absolute bottom-0 right-0 -z-10 opacity-80 pointer-events-none -translate-x-1 translate-y-0">
          <Image
            src="/images/boxbg.png"
            width={635}
            height={340}
            alt="background-box"
            className="w-[280px] sm:w-[400px] lg:w-[635px] h-auto hidden lg:block"
          />
        </div>
      </div>
    </div>
