...
export default function TestimonialSlider() {
  ...
  const getCardWidth = () => {
    switch (screenSize) {
      case 'mobile': return 'w-[85vw] max-w-[320px]'
      case 'tablet': return 'w-[320px]'
      case 'desktop': return 'w-[320px]'
  ...
  const getContainerHeight = () => {
    switch (screenSize) {
      case 'mobile': return 'h-[380px]'
      case 'tablet': return 'h-[400px]'
      case 'desktop': return 'h-[400px]'
              ...
              >
                <div className="relative bg-gradient-to-b from-[#1F1B48] to-[#00041E] rounded-2xl p-4 sm:p-6 lg:p-[23px] shadow-2xl overflow-hidden h-full">
                  ...
                  <div className="relative z-10 h-full flex flex-col">
                    <p className="text-[#F4F7FF] font-regular mb-4 sm:mb-6 lg:mb-[111px] text-sm sm:text-base leading-relaxed flex-grow">
                      {testimonial.text}
                    </p>
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      <div>
                        <p className="text-[#FFFFFF] font-semibold text-sm sm:text-base">{testimonial.author}</p>
                        <p className="text-[#FFFFFF] font-light text-xs sm:text-sm opacity-80">{testimonial.role}</p>
                      </div>
            ...
            <button
              ...
              className={`rounded-full transition-all duration-300 ${
                ...
                screenSize === 'mobile' 
                  ...
                  : index === currentSlide ? 'w-8 sm:w-12 h-1' : 'w-6 sm:w-8 h-1'
              }`}
