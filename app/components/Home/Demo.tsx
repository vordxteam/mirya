...
export default function Demo(): React.ReactElement {
  ...
  return (
    <>
      ...
      <div
        className="pt-[60px] py-100 pb-[90px] sm:pb-[229px] flex flex-col items-center relative overflow-hidden bg-[url('/images/main-gradient.png')] bg-no-repeat bg-bottom bg-contain"
      >
