...
export default function How1Card() {
  ...
  useEffect(() => {
    const timings = [
      ...
      800, // Step 1: Arrow 1 + Find (left) node
      1600, // Step 2: Arrow 2 + Find (right) node
      2400, // Step 3: Arrow 3 + Browse node
      3200, // Step 4: Arrow 4 + Type node
      4000, // Step 5: Arrow 5 + Speak node
      4800, // Step 6: Arrow 6 + Automate node
    ];
  ...
  return (
    <div
      className="backdrop-blur-[10px] backdrop-filter relative rounded-[20px] w-fit"
      data-name="Card"
    >
      <div className="relative p-10 rounded-[20px] border border-[#5747BF] bg-[#050A25] backdrop-blur-[10px]">
        <BgMg />
        <div
          className="relative bg-[#050a25] h-[534px] left-1/2 rounded-[12px] top-[36px] translate-x-[-50%] w-[574px]"
          data-name="Left"
        >
