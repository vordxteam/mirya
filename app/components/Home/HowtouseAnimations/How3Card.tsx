...
function Container() {
  return (
    <div
      className="bg-[rgba(255,255,255,0.08)] h-[36px] sm:h-[44px] relative rounded-[8px] shrink-0 w-full"
      data-name="container"
    >
      <div
        aria-hidden="true"
      ...
      />
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[8px] h-full items-center justify-center p-1.5 sm:p-[6px] relative w-full">
          <Cta />
          <Cta1 />
        </div>
      </div>
...
function SearchBar() {
  return (
    <motion.div
      className="bg-[rgba(255,255,255,0.08)] h-[32px] sm:h-[36px] relative rounded-[8px] shrink-0 w-full"
      data-name="search bar"
      initial={{ boxShadow: "0 0 0 rgba(2, 116, 254, 0)" }}
      animate={{
        boxShadow: [
    ...
    >
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] h-full items-start justify-center p-2 relative w-full">
          <Content />
        </div>
      </div>
      <div
...
function Containe() {
  return (
    <div
      className="content-stretch flex flex-col gap-3 sm:gap-[12px] items-start relative shrink-0 w-full"
      data-name="containe"
    >
      <Text />
      <Element />
...
function Left() {
  return (
    <div
      className="absolute bg-[#050a25] left-1/2 -translate-x-1/2 top-8 sm:top-12 w-[90%] sm:w-[85%] max-w-[544px] rounded-[12px]"
      data-name="Left"
    >
      <div className="box-border content-stretch flex flex-col gap-4 sm:gap-[22px] items-start overflow-clip p-3 sm:p-4 relative rounded-[inherit] w-full">
        <Container />
        <Containe />
        <div className="h-0 relative shrink-0 w-full" data-name="line">
          <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
...
function MousePointSvg() {
  return (
    <div
      className="h-[32px] sm:h-[42px] relative shrink-0 w-[32px] sm:w-[40px]"
      data-name="mouse-point.svg"
    >
      <svg
        className="block size-full"
...
function MousePointSvgFill() {
  return (
    <div
      className="content-stretch flex flex-col h-[32px] sm:h-[42px] items-center justify-center overflow-clip relative shrink-0 w-[32px] sm:w-[40px]"
      data-name="mouse-point.svg fill"
    >
      <MousePointSvg />
    </div>
...
function Container1() {
  return (
    <div
      className="absolute bottom-0 content-stretch flex flex-col items-start left-1/2 -translate-x-1/2"
      data-name="Container"
    >
      <MousePointSvg1 />
    </div>
...
function Svg() {
  return (
    <motion.div
      className="absolute h-[80px] sm:h-[121px] left-1/2 -translate-x-1/2 bottom-8 sm:bottom-12 w-[80%] sm:w-[530px]"
      data-name="Svg"
      animate={{
        y: [0, -5, 0],
        opacity: [0.7, 1, 0.7],
...
export default function How3Card() {
  return (
    <div
      className="backdrop-blur-[10px] backdrop-filter relative rounded-[20px] w-full max-w-[610px] h-[320px] sm:h-[489px] mx-auto overflow-hidden bg-[#050a25] border-t border-l border-r border-[#5747bf]"
      data-name="Card"
    >
      <div className="relative w-full h-full">
        ...
        <Left />
        <motion.div
          className="relative -z-10 w-full h-full left-0 sm:left-5 top-16 sm:top-[107px]"
          data-name="Icon"
          animate={{
            y: [0, -6, 0],
            rotate: [0, 2, 0, -2, 0],
