...
//             className="flex sm:min-h-[357px] min-h-[300px] flex-col justify-between rounded-[20px] sm:px-6 px-4 sm:py-8 py-4"
//             style={{
...
function TestimonialCard({
    ...
    return (
        <motion.div
            variants={cardVariants}
            className="flex sm:min-h-[432px] min-h-[300px] flex-col justify-between rounded-[20px] sm:px-6 px-4 sm:py-8 py-4"
            style={{
                background: "linear-gradient(180deg, #1F1B48 0%, #00041E 100%)",
            }}
        >
    ...
    return (
        <section className="relative bg-[#00031C] overflow-hidden">
            ...
            >
                ...
                {/* ── sm and above: original slide-of-6 grid layout ── */}
                <motion.div
                ...
                {/* ── below sm: one card per slide carousel ── */}
                <motion.div
