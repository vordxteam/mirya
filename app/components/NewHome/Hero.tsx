  ...
  return (
    <div>
      <div className="relative z-10 flex flex-col items-center justify-center pt-0 sm:pt-6 px-5 md:px-10 bg-[url('/images/herobg.png')] bg-no-repeat bg-bottom bg-contain">
        ...
        <h1 className="text-[30px] sm:text-[40px] md:text-[64px] font-medium leading-10 sm:leading-[50px] md:leading-[72px] tracking-[-1.44px] max-w-[1004px] w-full text-center pb-3 sm:pb-5">
          {t("hero.mainTitle")}{" "}
        </h1>
        <p className="text-[#CAC9D1] text-[14px] max-w-[688px] font-normal leading-5 pb-5 sm:pb-10 text-center">
          {t("hero.description")}
        </p>
        ...
        <div
          className="p-px rounded-3xl mt-14 shadow-[0_0_20px_0_rgba(2,116,254,0.32)]"
          style={{
            background:
