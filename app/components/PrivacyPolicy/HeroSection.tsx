  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-center pb-[75px] pt-0 sm:pt-10 px-2 md:px-10 bg-[url('/images/main-gradient.png')] bg-no-repeat bg-bottom bg-contain relative">
        ...
        <h1 className="text-[30px] max-w-[901px] sm:text-[40px] md:text-[64px] font-medium leading-10 sm:leading-[50px] md:leading-[72px] tracking-[-1.44px]  w-full text-center pb-3 sm:pb-6">
          {t("hero.title")}{" "}
        </h1>
...
//         <p
//           ref={paragraphRef}
//           className="text-[#CAC9D1] text-[14px] font-normal leading-5 pb-5 sm:pb-10 text-center max-w-[580px]"
//         >
//           {t("imprint.hero.description")}
//         </p>
//         <div className="flex items-center justify-center gap-3">
//           <div
//             className="rounded-full p-[0.8]"
