  ...
  const services = [
    {
      id: 1,
      icon: (
       <Image src="/images/Partner1.svg" alt={t("partner.card1.title")} width={40} height={40} />
      ),
    ...
    },
    {
      id: 2,
      icon: (
        <Image src="/images/Partner2.svg" alt={t("partner.card2.title")} width={40} height={40} />
      ),
    ...
    },
    {
      id: 3,
      icon: (
        <Image src="/images/Partner3.svg" alt={t("partner.card3.title")} width={40} height={40} />
    ...
    },
    {
      id: 4,
      icon: (
        <Image src="/images/Partner4.svg" alt={t("partner.card4.title")} width={40} height={40} />
      ),
...
function ServiceCard({
  ...
  return (
    <div
      className="p-[1px] rounded-xl h-full  overflow-hidden"
      style={{
        background:
          "linear-gradient(280deg, #22223C 49.47%, #686DDD 55.87%, #22223C 72.17%)",
      }}
    >
      <div
        className="py-8 px-7 h-full relative rounded-xl  overflow-hidden"
        style={{
          background:
      ...
      >
        ...
        <div className="absolute top-2 -right-70">
          <div className="rounded-[68.75px] bg-[#211F9CCC] blur-[50px] w-[493px] h-[213px]"></div>
        </div>
        ...
        <div className="relative z-10 space-y-4">
          <h3 className="heading-3 font-medium text-[#FFFFFF]">
            {service.title}
          </h3>
          <p className="heading-5 font-light  text-[#FFFFFFB8] max-w-[733px] leading-relaxed">
            {service.description}
          </p>
        </div>
      </div>
