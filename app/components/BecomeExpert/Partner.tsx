    ...
    flex text-center"
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <ServiceCard service={services[0]} isBig={false} />

            <div className="lg:col-span-2">
              <ServiceCard service={services[1]} isBig={true} />
            </div>

            <div className="lg:col-span-2">
              <ServiceCard service={services[2]} isBig={true} />
            </div>

            <ServiceCard service={services[3]} isBig={false} />
          </div>
        </div>
      </div>
    </>
      ...
      >
        <div
          className={`absolute pointer-events-none ${
            isBig
              ? "right-[-141.04px] top-[-86px]" // BIG card light
              : "right-[-134px] top-[-41px]" // SMALL card light
          }`}
        >
          <div
            className={`rounded-full opacity-60 bg-[#211F9CCC] blur-[90px] ${
              isBig ? "w-[520px] h-[240px]" : "w-[300px] h-[160px]"
            }`}
          ></div>
        </div>
