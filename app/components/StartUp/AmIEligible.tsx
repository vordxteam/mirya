...
//                 <h1 className="heading-1 font-medium text-[#FFFFFF]">
//                   Am I Eligible?
//                 </h1>
//                 <p className="heading-6 text-start font-normal text-[#CAC9D1]">
...
//                   <Image
//                     src="/images/tick-bg2.png"
//                     alt="Tick"
//                     height={40}
//                     width={40}
//                   />
//                   <p className="heading-4 font-medium text-[#F4F7FF]">
...
//                     width={40}
//                   />
//                   <p className="heading-4 font-medium text-[#F4F7FF] max-w-[496px]">
//                     You can use the startup discounted plan for one year, or
//                     longer if you still meet the requirements.
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//               Automate your first workflow and experience how quickly your team
//               can eliminate manual work and operate smarter.
//             </p>
//           </div>
//           <div className="absolute top-3 left-50 z-0 pointer-events-none">
...
export default function AmIEligible() {
  ...
  // FIX: Cast the translation result to a string array
  const criteria = (t("eligibility.criteria", { returnObjects: true }) || []) as string[];
        ...
        <div className="p-px w-full rounded-xl bg-[linear-gradient(180deg,#3F49D8_14.82%,#22223C_49.99%,#22223C_84.47%)]">
          <div className="bg-[#00031c] rounded-xl w-full h-full pb-3 pt-5 sm:pt-15 px-3 lg:px-20 flex flex-col md:flex-row justify-between ">
            <div className="space-y-16">
              ...
              <div>
                {/* FIX: Use the typed 'criteria' variable instead of inline t() */}
                {Array.isArray(criteria) && criteria.map((item: string, index: number) => (
                  <div key={index} className="p-3 flex gap-3 items-center">
                    <Image
                      ...
                      width={40}
                    />
                    <p className={`heading-4 font-medium text-[#F4F7FF] ${index === 2 ? "max-w-[496px]" : ""}`}>
                      {item}
                    </p>
                  </div>
                ))}
