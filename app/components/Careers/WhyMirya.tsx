  ...
  const reasons = [
    {
      ...
      discription:
        "Every workflow you design, every automation you build, and every idea you contribute helps organizations remove manual work and operate smarter.",
    },
    {
      id: "02",
      title: "Culture Built on Ownership",
      discription:
        "We believe the best ideas come from people who are trusted. At MIRYA, you’ll have autonomy, flexibility, and the freedom to take projects from concept to reality.",
    },
    {
      id: "03",
      title: "Innovation",
      discription:
        "We don’t follow trends, we create them. You’ll work with cutting-edge AI, automation intelligence, and modern engineering patterns.",
    },
  ];
  return (
    <div className=" px-3 sm:px-20 max-w-[1440px] mx-auto relative z-10 bg-[#00031C]">
      ...
      <div className="flex z-100 bg-[#00031C] flex-col items-center justify-center  pt-15 px-2 md:px-10  relative">
        ...
        <p className="text-[#CAC9D1] text-[14px] font-normal leading-5 pb-5 sm:pb-10 text-center max-w-[547px]">
          MIRYA is where innovators, builders, and problem-solvers come together
          to create automation that transforms how organizations work every day.
        </p>
      ...
      <div className=" pt-5 sm:pt-16 pb-10 sm:pb-15 grid sm:grid-cols-2 md:grid-cols-3 gap-6">
        {reasons.map((item) => (
          ...
          >
            <div
              key={item.id}
              className="p-6 space-y-3 bg-[#050A29] h-full  relative rounded-xl"
            >
