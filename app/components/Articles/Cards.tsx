...
const Cards = () => {
  ...
  return (
    <div className="bg-[#00031C] relative z-10 min-h-[80vh] flex items-center justify-center">
      {loading ? (
        // Centered circular loader
        <div className="flex items-center justify-center">
          <div className="w-16 h-16 border-4 border-whitea border-t-transparent rounded-full animate-spin"></div>
        </div>
      ) : (
        <div className="max-w-[1440px] m-auto px-5 sm:px-10 lg:px-20 pb-[60px] sm:pt-[60px] pt-0 overflow-hidden relative">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 pb-[60px]">
